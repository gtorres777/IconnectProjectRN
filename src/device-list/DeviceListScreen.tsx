...
const requestAccessFineLocationPermission = async () => {
  try {
    ...
    //   console.log("You can use Acess Fine Location")
    // } else {
    //   console.log("Access fine location Denied")
    // }
...
export default class DeviceListScreen extends React.Component {
  ...
  requestEnabled = async () => {
    try {
      ...
      let granted = await RNBluetoothClassic.requestBluetoothEnabled()

      if (granted){
        console.log("Bluetooth access granted successfully")
      } else {
